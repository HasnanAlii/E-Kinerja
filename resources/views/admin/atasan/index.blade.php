        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg min-h-[500px]">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                Kelola data struktural dan pimpinan unit kerja.
                            </p>
                        </div>
                    </div>

                    <a href="{{ route('admin.atasan.create') }}"
                       class="inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded-lg shadow hover:bg-indigo-700 transition duration-150 ease-in-out text-sm font-medium">
                ...
                <div class="p-6 bg-gray-50/30">
                    ...
                    {{-- Grid Layout: 1 col (HP), 2 col (Tablet), 3 col (Laptop) --}}
