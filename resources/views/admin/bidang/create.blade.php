        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-xl sm:rounded-xl border border-gray-200">
                ...
                <div class="px-6 py-5 border-b bg-gray-50 flex items-center space-x-3 rounded-t-xl">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800">Form Tambah Bidang</h3>
                        <p class="text-sm text-gray-500">
                            Masukkan nama bidang baru untuk ditambahkan ke sistem.
                        </p>
                    </div>
                </div>

                <form action="{{ route('admin.bidang.store') }}" method="POST" class="px-6 pb-6 space-y-8">
                    @csrf
