            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                ...
                <div class="bg-indigo-400 p-6 sm:p-10 text-white">
                    <div class="flex flex-col sm:flex-row items-center gap-6">
                        ...
                        {{-- Tanggal Penilaian --}}
                        <div class="mt-4 sm:mt-0 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-lg border border-white/20 text-center">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-white">
                                ...
                                <div>
                                    <p class="text-xs text-indigo-200 uppercase tracking-wider">Penilai</p>
                                    <p class="font-semibold">{{ $data->pegawai->atasan->user->name }}</p>
                                </div>
                ...
                <div class="p-6 sm:p-10">
                        ...
                        @foreach ($indikator as $key => $label)
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 border border-gray-100 hover:shadow-sm transition-shadow">
                                <div class="flex justify-between items-end mb-2">
                                    ...
                                    <span class="text-lg font-bold text-gray-800">{{ $nilai }} <span class="text-xs text-gray-400">/5</span></span>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    @if($data->kategori == 'Sangat Baik')
                                        <span class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-bold bg-green-100 text-green-700 border border-green-200">
                                            <i data-feather="star" class="w-3 h-3 mr-1.5"></i> Sangat Baik
                                        </span>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 flex justify-start">
                        <a href="{{ route('admin.penilaian.index') }}" 
                           class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 transition">
