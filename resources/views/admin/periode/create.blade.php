        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-xl sm:rounded-xl border border-gray-200">
                ...
                <div class="px-6 py-5 border-b bg-gray-50 flex items-center space-x-3 rounded-t-xl">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800">Form Tambah Periode</h3>
                        <p class="text-sm text-gray-500">Isi informasi berikut untuk membuat periode penilaian baru.</p>
                    </div>
                </div>

                {{-- FORM --}}
                <form action="{{ route('admin.periode.store') }}" method="POST" class="px-6 pb-6 space-y-8">
                    @csrf
